...
export class SoldierService{
    ...
    getSoldier( id: number){
      return this.soldiers[id]
    }

    buscarSoldier( busqueda: string): soldier[]{
      //Creo una variable local de tipo soldier de mi interface que sera un arreglo
      let soldierArr: soldier[]= [];
      ...
      //Aplico un ciclo for, para iterar los elementos del arreglo uno a uno
        /* for(let soldier of this.soldiers){ */
          ...
          //Y esta es una función que retorna, su pocisión 0 o superior, si no encuentra nada retorna -1
